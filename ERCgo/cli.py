...
def runParser():
  ...
  parser.add_argument('-i', '--interactome', required=False, metavar='path',
    help='''Path to interactome that will be used for the GO analysis''')
  
  parser.add_argument('-g', '--gaf', required=False, metavar='path',
    help='''Path to gene association file that will be used for the GO analysis''')
  
  parser.add_argument('-d', '--directory_input', required=False, metavar='dir_path',
